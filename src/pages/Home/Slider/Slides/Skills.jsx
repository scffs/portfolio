    ...
    return (
        <>
          <pre>
            ...
            <pre>&nbsp;&nbsp;
                <span className='blue'>React</span><span>:</span><span className='link'> 'beginner'</span><span>,</span>
            </pre>
            <pre>&nbsp;&nbsp;
                <span className='blue'>JavaScript</span><span>:</span><span className='link'> 'junior'</span><span>,</span>
            </pre>
            <pre>&nbsp;&nbsp;
