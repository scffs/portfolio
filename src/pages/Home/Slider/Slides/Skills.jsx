    ...
    return (
        <>
          <pre>
            ...
            <pre>&nbsp;&nbsp;
                <span className='text'>React</span><span>:</span><span className='link'> 'beginner'</span><span>,</span>
            </pre>
            <pre>&nbsp;&nbsp;
                <span className='text'>JavaScript</span><span>:</span><span className='link'> 'junior'</span><span>,</span>
            </pre>
            <pre>&nbsp;&nbsp;
            ...
            <pre>&nbsp;&nbsp;
                <span className='text'>C#</span><span>:</span><span className='link'> 'junior'</span><span></span>
            </pre>
